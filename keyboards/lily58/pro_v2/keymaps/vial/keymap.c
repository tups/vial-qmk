 ...
 * |      |      |      |      |      |      |-------.    ,-------|      | Left | Down |  Up  |Right |      |
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |      |RGB_T |RGB_M |RGB_HI|RGB_HD|RGB_SI|-------|    |-------|RGB_SD|RGB_VI|RGB_VD| Home | End  |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |LOWER | LGUI | Alt  | /Space  /       \Enter \  |BackSP| RGUI |RAISE |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `-------------------''-------'           '------''--------------------'
...
[_RAISE] = LAYOUT(
  ...
  _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI,   _______, _______, RGB_SAD, RGB_VAI, RGB_VAD, KC_HOME, KC_END, _______,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
...
static void render_status(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        ...
        case _ADJUST:
            ...
            break;
        default:
            sprintf(layer_misc, "MO(%01d)\n", get_highest_layer(layer_state));
            oled_write(layer_misc, false);
            break;
    }

    // WPM disabled to save space
